...
import com.livrariacorreta.livrariaapi.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar erro ao tentar fazer imprestimo de um livro inisistente.")
    ...
    @Test
    @DisplayName("Deve retornar 404 quando tentar devolver um livro inesistente. ")
    public void returnInesistentBookTest() throws Exception {
        // cenário
        ReturnedLoanDTO dto = ReturnedLoanDTO.builder().returned(true).build();
        String json = new ObjectMapper().writeValueAsString(dto);
